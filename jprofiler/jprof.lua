...
local msgpack_old = package.loaded["jprofiler/MessagePack"]
package.loaded["jprofiler/MessagePack"] = nil
local msgpack = require(_prefix .. "jprofiler/MessagePack")
package.loaded["jprofiler/MessagePack"] = msgpack_old
